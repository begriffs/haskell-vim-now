...
setup() {
  ...
  stack --resolver nightly-2015-12-08 install ghc-mod hdevtools hasktags codex hscope pointfree pointful-1.0.6 hoogle stylish-haskell --verbosity warning ; RETCODE=$?
