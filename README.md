...
```
**WARNING**: this command, once succeed, will _make backups and **remove**_ your existing VIM configuration. You can later [customize](#customizing) HVN configurations.
